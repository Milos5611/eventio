import { TYPE_KEY, tomorrow } from "../common/constant";
...
export function createEvent() {
    return ( dispatch, getState ) => {
        let data = {
            ...
            startsAt: getState().events.date ? getState().events.date.toISOString() : tomorrow.toISOString(),

...
class Events extends PureComponent {
	...
	renderEventCard(data, index) {
		const {loadEventDetails, list, grid, attendEvent, unAttendEvent, attended, userId} = this.props;
		return (
			<EventBox data={data} key={index} index={index} list={list} attended={attended}

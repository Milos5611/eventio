...
class Events extends Component {
	...
	renderEventCard(data, index) {
		const {loadEventDetails, list, grid, attendEvent, unAttendEvent, attended} = this.props;
		return (
			<EventBox data={data} key={index} index={index} loadEventDetails={loadEventDetails} grid={grid}
			          list={list} attendEvent={attendEvent} unAttendEvent={unAttendEvent} attended={attended}/>
		);
	}

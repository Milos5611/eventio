							...
							<div className={loginFail ? "error login-form" : "login-form"}>
								...
								<div className="password--wrapper">
									...
									<Checkbox
										...
										iconStyle={{fill: "rgba(0, 0, 0, 0.22)"}}
								...
								
								{
									location.pathname === "/signUp" ?
										<p className="signUp--bootom">Already have account? <Link to={"/login"}>SIGN IN</Link>
										</p>
										:
										<p className="signUp--bootom">Don’t have account? <Link to={"/signUp"}>SIGN UP</Link>
										</p>
								}
								
								<RaisedButton buttonStyle={style.button} className="btn-success"
